...
//public class AIAcademyOracleController {
//
//	@Autowired
//	AIAcademyOracleService service;
//
...
//	}
//
//	@RequestMapping(value = "/createAIAcademyOracleDb", method = { RequestMethod.POST })
//	public String createDb(@RequestBody RequestBodyClass requestBody) {
//		System.out.println("[DBController : signupNew]");
//		service.createAIAcademyOracleDb(requestBody.getReqId(), requestBody.getReqPw());
//		return "success";
//	}
//
//}

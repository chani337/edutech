...
//
//import com.smhrd.project.service.AIAcademyMariaService;
//
//@RequestMapping("dbaischool")
//@RestController
//@Qualifier("AIAcademyMariaDataSource")
//public class AIAcademyMariaController {
//
//	@Autowired
//	AIAcademyMariaService service;
//
...
//	}
//
//	@RequestMapping(value = "/createAIAcademyMariaDb", method = { RequestMethod.POST })
//	public String createDb(@RequestBody RequestBodyClass requestBody) {
//		System.out.println("[DBController : signupNew]");
//
//		// DB생성 부분
//		service.createAIAcademyMariaDb(requestBody.getReqId(), requestBody.getReqPw());
//
//		return "success";
//	}
//}

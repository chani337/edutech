...
//
//import com.smhrd.project.service.AIAcademyMysqlService;
//
//@RequestMapping("dbaischool")
//@RestController
//@Qualifier("AIAcademyMysqlDataSource")
//public class AIAcademyMysqlController {
//
//	@Autowired
//	AIAcademyMysqlService service;
//
...
//	}
//	
//	@RequestMapping(value = "/createAIAcademyMysqlDb", method = { RequestMethod.POST })
//	public String createDb(@RequestBody RequestBodyClass requestBody) {
//		System.out.println("[DBController : signupNew]");
//
//		// DB생성 부분
//		service.createAIAcademyMysqlDb(requestBody.getReqId(), requestBody.getReqPw());
//		return "success";
//	}
//}
